...
export async function fetch_available_translations(): Promise<Translation[]>
{
    const url = `${BASE_URL}/available_translations.json`;
    const data = await fetch_json<AvailableTranslationsResponse>(url);
